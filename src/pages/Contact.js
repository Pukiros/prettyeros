        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="contact-info-item padd-15">
              ...
              <h4>Message Me</h4>
              <p>Melvin Eros Pordan Cayaban</p>
            </div>
            <div className="contact-info-item padd-15">
              <div className="icon">
      ...
      <footer id="footer" className="footer_section pt-2 pb-2">
        <div className="container">
          <div className="footer-info">
            <p>&copy; Contact Me: <a href="/" className="ms-2"><span>Melvin Eros Pordan Cayaban</span></a></p>
            <div className="social-icons">
              <a href="https://github.com/AntonetteBarile04" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faGithub} size="2x" className="icon" />
              </a>
              <a href="" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faFacebook} size="2x" className="icon" />
              </a>
              <a href="mailto:ludzgalohitoro7@gmail.com" target="_blank" rel="noopener noreferrer">
